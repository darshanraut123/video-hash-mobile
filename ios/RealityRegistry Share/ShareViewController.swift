...
class ShareViewController: SLComposeServiceViewController {
 ...
 let hostAppBundleIdentifier = "org.reactjs.native.example.RealityRegistry"
 let shareProtocol = "org.reactjs.native.example.RealityRegistry" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
